...
function TimeLine() {
  return (
    <>
    <ol class="items-center hidden md:flex ">
    <li class="relative mb-6 sm:mb-0">
        ...
        <div class="mt-3 sm:pr-8   hover:bg-slate-50/20 rounded-xl hover:p-[20px] hover:backdrop-blur-sm transform hover:scale-105 duration-150 ease-linear hover:z-[5]">
    ...
    <li class="relative mb-6 sm:mb-0">
        ...
        <div class="mt-3 sm:pr-8  hover:bg-slate-50/20 rounded-xl hover:p-[20px] hover:backdrop-blur-sm transform hover:scale-105 duration-150 ease-linear ">
...
<ol class="sm:relative md:hidden border-l border-gray-200 dark:border-gray-700 m-[20px]">                  
    <li class="mb-10 ml-6">            
